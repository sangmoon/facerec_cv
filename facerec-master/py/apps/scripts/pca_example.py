...
if __name__ == "__main__":
    ...
    # your image data:
    if len(sys.argv) < 4:
        print "USAGE: facerec_demo.py </path/to/images> <name> </path/to/test_images>"
        sys.exit()
    # Now read in the image data. This must be a valid path!
    [X,y] = read_images2(sys.argv[1])
    [Tx, ty] = read_images2(sys.argv[3])
    ...
    subplot(title="PCA", images=E, rows=4, cols=4, sptitle="PCA", colormap=cm.jet, filename="pca_%s.png" % sys.argv[2])
